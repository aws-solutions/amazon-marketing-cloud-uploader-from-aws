    ...
    try:
        ...
        try:
            ...
            try:
                ...
                new_variables = {"API_ENDPOINT": api_endpoint, "AWS_REGION": region, "USER_POOL_ID": user_pool_id, "USER_POOL_CLIENT_ID": client_id, "IDENTITY_POOL_ID": identity_id, "DATA_BUCKET_NAME": data_bucket_name, "ARTIFACT_BUCKET_NAME": artifact_bucket_name, "ENCRYPTION_MODE": encryption_mode}
            ...
            send_response(event, context, "FAILED", {"Message": error_response_str})
...
def purge_bucket(event, context):
    try:
        bucket_name = event["ResourceProperties"]["DeploymentBucket"].split('.')[0]
