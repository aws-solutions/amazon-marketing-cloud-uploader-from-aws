...
def test_everything(browser, test_environment, stack_resources):
    ...
    browser.find_element(
        "xpath",
        "/html/body/div/div/div/div[2]/div/div[2]/div[1]/div[3]/div[2]/label/span",
    ).click()
    assert browser.find_element(
        "xpath",
        "/html/body/div/div/div/div[2]/div/div[2]/div[1]/div[4]/select",
    )

    # validate create dataset button triggers name form field
    browser.find_element(
        "xpath",
        "/html/body/div/div/div/div[2]/div/div[2]/div[1]/div[3]/div[1]/label/span",
    ).click()
    assert browser.find_element(
        "xpath",
        "/html/body/div/div/div/div[2]/div/div[2]/div[1]/div[4]/div[1]/div/input",
    )
    ...
    browser.find_element(
        "xpath",
        "/html/body/div/div/div/div[2]/div/div[2]/div[1]/div[4]/div[3]/div[1]/fieldset/div/div/div[1]/label/span",
    ).click()
